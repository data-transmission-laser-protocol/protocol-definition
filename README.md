...
# Upcoming Versions
- The 2nd version supports data encryption. The data are encrypted in transmitter end before sending and decrypted in receiver end after data transmission completed.
